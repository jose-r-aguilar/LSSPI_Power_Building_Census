...
citizenship_clean <- citizenship_data %>%
  ...
  mutate(
    age_category = case_when(
      variable %in% c("B05003I_004", "B05003I_005", "B05003I_006", "B05003I_007",
                      "B05003I_015", "B05003I_016", "B05003I_017", "B05003I_018") ~ "Under 18",
      variable %in% c("B05003I_009", "B05003I_010", "B05003I_011", "B05003I_012",
                      "B05003I_020", "B05003I_021", "B05003I_022", "B05003I_023") ~ "18 or Older",
      TRUE ~ NA_character_
    ),
    status = case_when(
...
write.csv(final_citizenship_data, "citizenship_status_percentages_by_age.csv", row.names = FALSE)
